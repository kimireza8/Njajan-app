                ...
                <div class="widget-content widget-categories">
                  <ul class="nav nav-category">
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link active" aria-current="page" href="#">Makanan <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <li class="nav-item border-bottom w-100">
                      <a class="nav-link" href="#">Minuman <i class='bx bx-chevron-right'></i></a>
                    </li>
                    <!-- <li class="nav-item border-bottom w-100">
          ...
          <section class="col-lg-9 col-md-12 products">
            <div class="card mb-4 bg-light border-0 section-header">
              <div class="card-body p-5">
                <h2 class="mb-0">Kategori Makanan</h2>
              </div>
            </div>
            <div class="row">
              <div class="d-lg-flex justify-content-between align-items-center">
                <div class="mb-3 mb-lg-0">
                  <p class="mb-0"> <span class="text-dark">24 </span> produk ditemukan </p>
                </div>
            ...
            <div class="row">
              <div class="col-lg-3 col-6">
                <div class="card card-product card-body p-lg-4 p3">
                  <a href="product.html"><img src="{{ asset('themes/njajan/assets/img/makanan/seblak.jpg') }}" alt="" class="img-fluid"></a>
                  <h3 class="product-name mt-3">Seblak</h3>
                  <div class="rating">
              ...
              <div class="col-lg-3 col-6">
                <div class="card card-product card-body p-lg-4 p3">
                  <a href="product.html"><img src="{{ asset('themes/njajan/assets/img/makanan/mie tek tek.jpeg') }}" alt="" class="img-fluid"></a>
                  <h3 class="product-name mt-3">Mie Tek-tek Goreng</h3>
                  <div class="rating">
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
              ...
              <div class="col-lg-3 col-6 mt-3 mt-lg-0">
                <div class="card card-product card-body p-lg-4 p3">
                  <a href="product.html"><img src="{{ asset('themes/njajan/assets/img/makanan/nasi uduk.jpg') }}" alt="" class="img-fluid"></a>
                  <h3 class="product-name mt-3">Nasi Uduk</h3>
                  <div class="rating">
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
              ...
              <div class="col-lg-3 col-6 mt-3 mt-lg-0">
                <div class="card card-product card-body p-lg-4 p3">
                  <a href="product.html"><img src="{{ asset('themes/njajan/assets/img/makanan/mie nyemek.jpg') }}" alt="" class="img-fluid"></a>
                  <h3 class="product-name mt-3">Mie Nyemek</h3>
                  <div class="rating">
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
              ...
              <div class="col-lg-3 col-6 mt-3 mt-lg-0">
                <div class="card card-product card-body p-lg-4 p3">
                  <a href="product.html"><img src="{{ asset('themes/njajan/assets/img/makanan/tahu bakso.jpg') }}" alt="" class="img-fluid"></a>
              ...
              <div class="col-lg-3 col-6 mt-3 mt-lg-0">
                <div class="card card-product card-body p-lg-4 p3">
                  <a href="product.html"><img src="{{ asset('themes/njajan/assets/img/makanan/corn dog.jpg') }}" alt="" class="img-fluid"></a>
                  <h3 class="product-name mt-3">Corn Dog</h3>
                  <div class="rating">
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
                    <i class="bx bxs-star"></i>
